...
const SelfClosingElements_1 = __importDefault(require("../config/SelfClosingElements"));
const UnclosedElements_1 = __importDefault(require("../config/UnclosedElements"));
